Create one horizontal animation strip for Codex pet `guga`, state `running-right`.
...
Identity: same pet in every frame: A rounder and cuter chibi penguin hoodie girl pet with a softer face and friendlier proportions. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
